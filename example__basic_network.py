...
def main():
    ...
    network = Network()
    # Then, overwrite its default config with your custom one
    ...
    network.add_neuron("hidden1", value=0, position=(250, 175), n_type="hidden")
    network.add_neuron("output1", value=0, position=(400, 175), n_type="output")
