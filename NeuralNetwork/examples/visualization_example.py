...
class NetworkVisApp(QtWidgets.QMainWindow):
    ...
    def create_sample_network(self):
        ...
        for name, n_type, pos in neuron_definitions:
            network.add_neuron(name, value=random.uniform(0,100), position=pos, neuron_type=n_type)
    ...
    def run_random_stimulation(self):
        ...
        if changes:
            ...
            for name in changes:
                self.vis.highlight_neuron(name, 0.7, effect_type='activity')
    ...
    def add_new_random_neuron(self):
        ...
        self.network.add_neuron(new_name, value=50.0, position=pos, neuron_type=n_type)
    ...
    def run_propagation(self):
        ...
        for name in self.network.neurons:
             self.vis.highlight_neuron(name, 0.5, effect_type='activity_pulse')
